                                ...
                                <table style="font-size:11px;" class="table small table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                            ...
                                            $sql = "SELECT * FROM business WHERE activ = 'Y' and electoral_area='sakumono' ORDER BY id DESC";
                                        ...
                                        <thead>
                                         ...
                                         <tbody>
                                            ...
                                            $no    = 1;
                                            $email = $_SESSION['email'];
                                            $sql = "SELECT * FROM business WHERE activ = 'Y' and electoral_area='sakumono' ORDER BY id DESC LIMIT 500";
