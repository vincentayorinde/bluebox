    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ALL BUSINESS
                    <small>View Records by Electoral Area</small>
                </h2>
            </div>
            <!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   ...
                   <div class="card">
                        <div class="header">
                            ...
                            <strong>showing latest 100 data </strong>
                                ...
                                <table style="font-size:11px;" class="table small table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                            ...
                                            $sql = "SELECT * FROM business WHERE activ = 'Y' ORDER BY id DESC LIMIT 100";
                                            ...
                                            if($result->num_rows > 0) {
                                                ...
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td>" .$row['tel_no']."</td>
                                                    <td>" .number_format($row['b_charge'], 2, '.', ',')."  -
