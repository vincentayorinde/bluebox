                                    ...
                                    <tbody>
                                      <?php
                                            ...
                                            $email = $_SESSION['email'];
                                                 ...
                                                 $sql = "SELECT * FROM building_payment WHERE activ = 'Y'";
                                            ...
                                            if($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td>
                                                    <a href='update-payment-b-permit?id=".$row['id']."&b_permit_acct_no=".$row['b_permit_acct_no']."'>Edit
                                                    </a>
                                                     <a href='print-bill-b-permit?id=".$row['id']."&p_no=".$row['b_permit_acct_no']."'>Print
                                                    </a>
                                                    <a href='delete-p-bp?bp_id=".$row['id']."&bp_no=".$row['b_permit_acct_no']."'>Delete</a>
                                                    </td>
                                                    </tr>";
                                                    $no++;
                                                }
