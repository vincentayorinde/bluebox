...
require_once 'db/config.php';
    ...
    if ($_GET['b_permit_acct_no']){
                  $b_permit_acct_no        = $_GET['b_permit_acct_no'];
                  $id__               = $_GET['id'];

                  $sqlnew = "SELECT * FROM building WHERE b_permit_acct_no = '$b_permit_acct_no'";
                  $resultnew = $connect->query($sqlnew);
                  $data = $resultnew->fetch_assoc();



                  $sql__ = "SELECT * FROM building_payment WHERE b_permit_acct_no = '$b_permit_acct_no' AND id='$id__' order by id desc";
      ...
      if (isset($_POST['rate_charge'])){
        $sqlnewb = "SELECT sum(paid) as p_total FROM building_payment WHERE b_permit_acct_no = '$b_permit_acct_no'";
                  ...
                  $datab = $resultnewb->fetch_assoc();
                      ...
                      // Update quote exists
                        $query = "INSERT INTO building_payment (b_permit_acct_no, rate_impost, rate_charge, arrears, paid, total_amt_due, bal, payment_mode,bank,cheque_no,gcr,user_id,user_email,activ)VALUES('$b_permit_acct_no', '$rate_impost', '$rate_charge', '$arrears', '$paying', '$total_amt_due', '$bal', '$payment_mode','$bank','$cheque_no','$gcr','$userid','$uemail','Y')";
                                $result = mysqli_query($connect,$query);
                                if($result){
                                   $sqlss = "SELECT id,b_permit_acct_no FROM building_payment WHERE b_permit_acct_no = '$b_permit_acct_no' order by id desc";
    ...
    <section class="content">
        <div class="container-fluid">
           <!--  <div class="block-header">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>BUILDING PERMIT PAYMENT DETAILS</h2>
         ...
         <div class="form-line"> <input type="number" placeholder="00.00" step="0.01" min="0"  placeholder="Enter Amount"  class="form-control" name="paying" id="paying_id"  required>
                       ...
                       <div class="form-line">
                          <input type="text" value="<?php echo $data['b_permit_acct_no']; ?>" class="form-control" name="b_permit_acct_no" id="b_permit_acct_no_id"  required readonly="">
                       ...
                       <div class="form-line">
                          <input type="text" value="<?php echo $data['b_permit_owner_name']; ?>" class="form-control" name="b_permit_owner_name" id="b_permit_owner_name_id"  required readonly="">
