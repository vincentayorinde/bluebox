...
require_once 'db/config.php';
    ...
    if ($_GET['pro_acct_no']){
                  ...
                  $sql__ = "SELECT * FROM property_payment WHERE pro_acct_no = '$pro_acct_no' AND id='$id__' order by id desc";
        ...
        $sqlnewb = "SELECT sum(paid) as p_total FROM property_payment WHERE pro_acct_no = '$pro_acct_no'";
                  ...
                  $datab = $resultnewb->fetch_assoc();
                        ...
                        // echo $amt_paid_new = floatval($amt_paid_new);
                         ...
                         $actual_discount     = $post['actual_discount_'];
                      ...
                      // Update quote exists
                        $query = "INSERT INTO property_payment (pro_acct_no, rateable_value, rate_impose, rate_charge, arrears, paid, total_amt_due, bal, payment_mode,bank,cheque_no,gcr,discount, actual_discount,user_id,user_email,activ)VALUES('$pro_acct_no', '$rateable_value', '$rate_impose', '$rate_charge', '$arrears', '$paying', '$total_amt_due', '$bal', '$payment_mode','$bank','$cheque_no','$gcr','$discount','$actual_discount','$userid','$uemail','Y')";
                               ...
                               $msg = '<div class="alert alert-success">Payment entered successfully <a class="btn btn-info waves-effect" href="property-payment-list">See List</a>
    ...
    <section class="content">
        <div class="container-fluid">
         ...
         <div class="form-line"> <input type="number" placeholder="00.00" step="0.01" min="0"  placeholder="Enter Amount"  class="form-control" name="paying" id="paying_id"  required>
                                 ...
                                 <p>
                                        <b>Discount for Retiree/ Disabled</b>
                                    </p>
                <select class="form-control show-tick dis"   name="discount" id="discount_id" required="">
                                    <option value="N\A">Select percentage</option>
                       ...
                       <div class="form-group form-float">
                                  ...
                                  <div class="col-md-3" id="rate-charge">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
    <input type="text" value="<?php echo  $data__['rate_charge']; ?>" class="form-control"  name="rate_charge" id="rate_charge_id" readonly="" required>
                                            
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3" id="discount_value">
                                    <p>
                                        <b>Discount Value</b>
                                    </p>
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
             <input type="number" value="<?php echo  $data__['actual_discount']; ?>" class="form-control"  name="actual_discount_" id="actual_discount"  required readonly="">
...
<div class="clearfix"></div>
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBtwdU-k6I92E2C6zqsC6xPFlRUACzhmXc&libraries=places&callback=initMap"
    ...
    <script type="text/javascript">
        $(".dis").on("change paste keyup", function() {
            var dis  = $("#discount_id").val()/100 *  $("#rate_charge_id").val();
            $('#actual_discount').val(dis);
           var charge = $('#rate_charge_id').val() - $('#actual_discount').val();
           // alert(charge);
           $('#rate_charge_id').val(charge);
        });
