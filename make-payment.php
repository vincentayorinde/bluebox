    ...
    // BOP PAYMENT
      ...
      if (isset($_POST['pay-bop'])){
                        ...
                        if($result->num_rows > 0){
                              header("Location: enter-payment-pay-now-bop?id=".$row_['id']."&b_no=".$row['b_no']."");
                         }
             }
...
<head>
    ...
    <title>Make Payment | <?php echo $name; ?></title>
    <!-- Favicon-->
...
<div class="clearfix"></div>
                             <!--    <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary waves-effect" value="BOP Payment" name="pay-bop" id="pay-bop"> 
                            </form>
                         </div>
...
<div class="clearfix"></div>
                               <!--  <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary waves-effect" value="PR Payment" name="pay-pr" id="pay-pr"> 
                            </form>
...
<div class="clearfix"></div>
                               <!--  <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary waves-effect" value="Enter Payment" name="pay-bp" id="pay-bp"> 
                            </form>
                        </div> <!-- End body real form -->
                    </div>
                           </div>
         ...
         <!-- SIGNAGE FORM -->
                    <div id="make_signage_payment">                        
                                 <div class="body"><h5>SIGNAGE PAYMENT</h5>
                            <form id="validation" method="post">
                          <input hidden="" name="userid" value="<?php echo $_SESSION['user_data']['id'];?>">
                          <input hidden="" name="uemail" value="<?php echo $_SESSION['email'] ?>">
                          <input hidden="" name="company" value="<?php echo $_SESSION['user_data']['company'];?>">
...
<div class="clearfix"></div>
                               <!--  <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary waves-effect" value="Enter Payment" name="pay-sg" id="pay-sg"> 
                            </form>
                        </div> <!-- End body real form -->
                    </div>
