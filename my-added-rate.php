                                ...
                                <table style="font-size:11px;" class="table small table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                           ...
                                           $sql = "SELECT * FROM property WHERE activ = 'Y' AND user_email = '$email'";
                                            ...
                                            if($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td>
                                                            <a href='update-rate.php?id=".base64_encode($row['id'])."'><button class='btn btn-primary btn-tiny btn-circle waves-effect waves-circle' type='button'><i class='material-icons'>mode_edit</i></button></a>
                                                                                                                </td>
                                                    </tr>";
                                                    $no++;
                                                }
