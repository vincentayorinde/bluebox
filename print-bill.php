...
<head>
    ...
    <title>Print Bill | <?php echo $name; ?></title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <a href="all-business" class="btn btn-primary waves-effect">BOP Bills </a>
                <a href="all-rates" class="btn btn-primary waves-effect">Property Rate Bills </a>
                <a href="all-building-permit" class="btn btn-primary waves-effect">Building Permit Bills </a>
                <a href="all-signage" class="btn btn-primary waves-effect">Signage Bills </a>
                               
               <!--  <select class="form-control show-tick"   name="prind_bill _data" id="print_bill_id" required="">
                                    <option value="N\A">Select Bill</option>
                                    <option value="bop_data">BOP</option>
                                    <option value="property_rate_data">Property Rate</option>
                                    <option value="building_permit_data">Building Permit</option>
                                    <option value="signage_data">Signage</option>
                        </select> -->
                                </div>
