...
require_once 'db/config.php';
    ...
    // BOP ENTRY
      ...
      if (isset($_GET['bp-date-from'])){

                         $bp_date_from = $_GET['bp-date-from'];
                         $bp_date_from = date("Y-m-d", strtotime($bp_date_from));

                         $bp_date_to = $_GET['bp-date-to'];
                         $bp_date_to = date("Y-m-d", strtotime($bp_date_to));


                        header("Location: report-detail-print-bp?sd=".$bp_date_from."&ed=".$bp_date_to."");
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="bp-date-from" id="bp-date-from" placeholder="Select Start date">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="bp-date-to" id="bp-date-to" placeholder="Select End Date">
                                        </div>
                                    </div>
                                </div>
                               <!--  <div class="col-sm-4">
