...
require_once 'db/config.php';
    ...
    // BOP ENTRY
      ...
      if (isset($_GET['pr-date-from'])){

                         $pr_date_from = $_GET['pr-date-from'];
                         $pr_date_from = date("Y-m-d", strtotime($pr_date_from));

                         $pr_date_to = $_GET['pr-date-to'];
                         $pr_date_to = date("Y-m-d", strtotime($pr_date_to));


                        header("Location: report-detail-print-pr?sd=".$pr_date_from."&ed=".$pr_date_to."");
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="pr-date-from" id="pr-date-from" placeholder="Select Start date">
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" name="pr-date-to" id="pr-date-to" placeholder="Select End Date">
                                        </div>
                                    </div>
                                </div>
                               <!--  <div class="col-sm-4">
