...
require_once 'db/config.php';
    ...
    // BOP ENTRY
      ...
      if (isset($_GET['bop-date-from'])){
                         $bop_date_from = $_GET['bop-date-from'];
                         // $bop_date_from = date("Y-m-d", strtotime($bop_date_from));

                         $bop_date_to = $_GET['bop-date-to'];
                         $area = $_GET['area'];
                         // $bop_date_to = date("Y-m-d", strtotime($bop_date_to));


                        header("Location: report-detail-print?sd=".$bop_date_from."&ed=".$bop_date_to."&area=".$area."");
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="datetime-local" step=".001" class="form-control" name="bop-date-from" id="bop-date-from" placeholder="Select Start date">
                                         <!--    <input type="text" class="datepicker form-control" name="bop-date-from" id="bop-date-from" placeholder="Select Start date"> -->
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="datetime-local" step=".001" class="form-control" name="bop-date-to" id="bop-date-to" placeholder="Select End Date">
                                            <!-- <input type="text" class="datepicker form-control" name="bop-date-to" id="bop-date-to" placeholder="Select End Date"> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                        <select class="form-control show-tick" name="area" id="area" required="">
