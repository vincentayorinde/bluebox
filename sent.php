     ...
     if(isset($_SESSION['user_data']['user_role']) == "agent" || $_SESSION['user_data']['user_role'] == "adminxz"){
      ...
      if(isset($_POST['deleteBtn'])){
        ...
        foreach ($_POST as $key => $value){
            ...
            if($key != "deleteBtn"){
                 $sql = mysqli_query($connect, "UPDATE private_messages SET senderDelete='1', opened='1'
                                                WHERE id = '$value' AND from_id = '$my_id' LIMIT 1 ");
...
<head>
    ...
    <title>Sent | Pacific Heavens Logistics</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                SENT MESSAGES <a href="compose-message.php" class="btn bg-red waves-effect"><i class="material-icons">mode_edit</i>
                                    <span>COMPOSE</span>
                                </a>
                            </h2>
...
<?php 
    ...
    $sql = mysqli_query($connect, "SELECT * FROM private_messages WHERE from_id = '$my_id' AND senderDelete = '0'
    ...
    while($row = mysqli_fetch_assoc($sql)){
        ...
        $ret = mysqli_query($connect, "SELECT id, email, first_name, last_name FROM users WHERE id = '$to_id' LIMIT 1");
