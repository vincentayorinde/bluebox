...
require_once 'db/config.php';
    ...
    if ($_GET['b_permit_acct_no']){
                  ...
                  $sql__ = "SELECT * FROM building_payment WHERE b_permit_acct_no = '$b_permit_acct_no' AND id='$id__' ";
      ...
      if (isset($_POST['rate_charge'])){
        $sqlnewb = "SELECT sum(paid) as p_total FROM building_payment WHERE b_permit_acct_no = '$b_permit_acct_no'";
                  ...
                  $datab = $resultnewb->fetch_assoc();
                   ...
                   $query = "UPDATE building_payment SET paid='$paying', bal='$bal', payment_mode='$payment_mode',bank='$bank',cheque_no='$cheque_no',gcr='$gcr' WHERE id='$id__' ";
                               ...
                               $msg = '<div class="alert alert-success">Payment updated successfully <a class="btn btn-info waves-effect" href="b-permit-payment-list">See List</a>
