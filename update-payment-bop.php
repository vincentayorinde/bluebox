      ...
      if (isset($_POST['paying'])){
         $sqlnewb = "SELECT sum(paid) as p_total FROM bop_payment WHERE b_no = '$b_no'";
                  ...
                  $datab = $resultnewb->fetch_assoc();
                      ...
                      // Update quote exists
       $query = "UPDATE bop_payment
       SET b_name='$b_name',payment_mode='$payment_mode',paid='$paying',bal='$bal',b_charge='$b_charge',arrears='$b_arrears',bank='$bank',cheque_no='$cheque_no',gcr='$gcr',user_id='$userid',user_email='$uemail' WHERE id='$id__' ";
                                ...
                                $msg = '<div class="alert alert-success">Payment updated successfully <a class="btn btn-info waves-effect" href="bop-payment-list">See List</a>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          ...
                          <input hidden="" name="company" value="<?php echo $_SESSION['user_data']['company'];?>">
                           <a href="enter-payment-bop" class="btn btn-primary waves-effect">Change Business </a> 
