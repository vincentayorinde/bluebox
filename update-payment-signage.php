...
require_once 'db/config.php';
    ...
    if ($_GET['signage_acct_no']){
                  ...
                  $sql__ = "SELECT * FROM signage_payment WHERE signage_acct_no = '$signage_acct_no' AND id='$id__' ";
      ...
      if (isset($_POST['rate_charge'])){
        $sqlnewb = "SELECT sum(paid) as p_total FROM signage_payment WHERE signage_acct_no = '$signage_acct_no'";
                  ...
                  $datab = $resultnewb->fetch_assoc();
                   ...
                   $query = "UPDATE signage_payment SET paid='$paying', bal='$bal', arrears='$arrears', payment_mode='$payment_mode',bank='$bank',cheque_no='$cheque_no',gcr='$gcr' WHERE id='$id__' ";
                               ...
                               $msg = '<div class="alert alert-success">Payment updated successfully <a class="btn btn-info waves-effect" href="signage-payment-list">See List</a>
...
<head>
    ...
    <title>Update Signage Payment | <?php echo $name; ?></title>
    <!-- Favicon-->
 ...
 <div class="form-line"> <input type="text" value="<?php echo $data__['gcr']; ?>" placeholder="Enter GCR No."  class="form-control" name="gcr" id="gcr" required="">
        ...
        <div class="form-line"> <input type="text" value="<?php if(!$data__['cheque_no']){echo "NA";}else{echo $data__['cheque_no'];} ?>"  placeholder="Enter Cheque No."  class="form-control" name="cheque_no" id="cheque_id">
         ...
         <div class="form-line"> <input type="number" placeholder="00.00" min="0"  placeholder="Enter Amount"  class="form-control" name="paying" id="paying_id" value="<?php echo $data__['paid']; ?>"  required>
                       ...
                       <div class="form-line">
                          <input type="text" value="<?php echo $data['signage_acct_no']; ?>" class="form-control" name="signage_acct_no" id="b_permit_acct_no_id"  required readonly="">
